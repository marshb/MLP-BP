...
if __name__ == "__main__":
    ...
    model_settings = "MLP_ECGPPG_NP%s_D%s_DP%s_TD%s_CD%s_dr%s_v40" % (num_peaks, dim,
                                                                            depth, token_dim,
    ...
    train_data = MIMIC_II_Rpeaks_align_v2(train_ecg_list, train_ppg_list, train_BP_list)
    ...
    model = MLPMixer(in_channels=in_channel, num_patch=128, num_classes=num_classes,
